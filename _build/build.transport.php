...
$sources = array(
    ...
    'source_assets' => array(
        'components/minishop2/payment/assistbelarus.php'
    ),
    'source_core' => array(
        'components/minishop2/custom/payment/assistbelarus.class.php',
        'components/minishop2/lexicon/en/msp.assistbelarus.inc.php',
        'components/minishop2/lexicon/ru/msp.assistbelarus.inc.php'
    )
,'docs' => $root . 'docs/'
);
